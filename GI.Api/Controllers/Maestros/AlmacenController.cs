...
namespace GI.Api.Controllers.Maestros
{
    ...
    {
        private readonly IAlmacenesCrudCU _AlmacenesCrudCU;

        public AlmacenController(IAlmacenesCrudCU AlmacenesCrudCU)
        {
            _AlmacenesCrudCU = AlmacenesCrudCU;
        }

        #region Querys
        [HttpGet("")]
        public async Task<IActionResult> Consultar(AlmacenConsultarRQ oFiltro)
        {

            var oResult = await _AlmacenesCrudCU.Consultar(oFiltro);
        ...
        {
            var oResult = await _AlmacenesCrudCU.BuscarPorID(id);
        ...
        [HttpPost("")]
        public async Task<IActionResult> Crear(AlmacenCrearRQ oRegistro)
        {
            if (oRegistro == null)
            {
            ...
            var oResult = await _AlmacenesCrudCU.Crear(oRegistro);
        ...
        [HttpPut("{id:int}")]
        public async Task<IActionResult> Actualizar(int id, AlmacenActualizarRQ oRegistro)
        {
            if (oRegistro == null)
            {
            ...
            var oResult = await _AlmacenesCrudCU.Actualizar(id, oRegistro);
        ...
        public async Task<IActionResult> Eliminar(int id)
        {
            ...
            var oResult = await _AlmacenesCrudCU.Eliminar(id);
